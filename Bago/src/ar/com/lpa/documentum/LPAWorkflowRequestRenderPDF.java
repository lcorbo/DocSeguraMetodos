...
public class LPAWorkflowRequestRenderPDF implements IDmMethod {
	...
	public void execute(Map params, OutputStream ostream) throws Exception {
		...
		try {
			...
			dmcDoc.queue("dm_autorender_win31", "rendition", 1, false, null,
					"rendition_req_ps_pdf");
			if (debug)
				logger.write("Envia la solicitud de rendicion a PDF");
