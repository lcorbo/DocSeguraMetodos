...
public class LPAWorkflowChangeEditor implements IDmMethod {
	...
	public void execute(Map params, OutputStream ostream) throws Exception {
		...
		try {
			...
			dmcDoc.setString("p_editor", parametros.getString("bpm_editor"));

			dmcDoc.save();

			if (debug)
				logger.write("Cambia el editor del documento");
